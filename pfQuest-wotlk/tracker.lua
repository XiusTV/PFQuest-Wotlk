...
if Questie and Questie.LoaderInitialized then
  pfQuest = pfQuest or {}
  if not pfQuest.tracker or pfQuest.tracker.__isStub ~= true then
    local stub = {}
    stub.__isStub = true
    stub.Reset = function() end
    stub.ButtonAdd = function() end
    function stub:Show() end
    function stub:Hide() end
    pfQuest.tracker = stub
  end
  return
end
